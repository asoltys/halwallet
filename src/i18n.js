...
const STR = {
  en: {
    ...
    onbWelcomeBody: 'A bitcoin wallet that lives in your browser: instant payments, encrypted chat, and your keys never leave the device. Ready to get started?',
    onbStart: "Let's go",
    onbHaveWallet: 'I already have a wallet',
    onbNostrTitle: 'Do you already have a nostr account?',
    onbNostrBody: 'Sign in with it and your wallet, name, and profile come with you. No idea what nostr is? No problem — we\u2019ll set everything up fresh.',
    onbNostrYes: 'Yes — sign me in',
