...
const STR = {
  en: {
    ...
    hiwLnTitle: 'Lightning',
    hiwLn1: 'You can pay Lightning invoices and receive Lightning payments. Behind the scenes a swap provider exchanges between your on-chain coins and Lightning without ever holding your money — if a swap fails, the coins come back to you. A small swap fee applies, shown before you confirm.',
    hiwArkTitle: 'Ark',
    hiwArk1: 'Ark is a newer way to pay off-chain: sends arrive instantly, cost no mining fees, and stay self-custodial. You "board" coins from your on-chain balance into an Ark server, pay and receive freely, and move funds back on-chain whenever you like.',
    hiwArk2: 'The server can never take your money: every coin you hold in the Ark comes with a pre-signed escape route, and the wallet can put it back on-chain even if the server disappears (“Exit on-chain without the server” in Settings — it takes a while and needs a little on-chain balance for fees, but it needs nobody’s permission).',
    hiwArk3: 'The housekeeping: Ark coins expire after some weeks, so refresh them (Settings) before then — a wallet left untouched past expiry can be swept by the server. Boarding pays a small server fee plus a normal mining fee; paying inside the Ark is free; withdrawing on-chain pays a server fee taken from the amount.',
    hiwSpTitle: 'Silent payments',
    ...
    arkOffboardedTitle: 'Withdrawing!',
    arkOffboardedNote: 'Arrives in this wallet’s on-chain balance after 1 confirmation.',
    arkOffboarded: 'Withdrawn on-chain',
    arkOffboardHistory: 'Ark withdrawal',
    arkExitBtn: 'Exit on-chain without the server ({n} coin(s))',
    arkExitStarted: 'Unilateral exit started for {n} coin(s) — broadcasting the exit chain.',
    arkExitNoFeeCoin: 'Exiting needs an on-chain coin to pay the exit-chain fees.',
    arkExitChainStatus: 'Exiting {n} sats — publishing on-chain, step {done} of {total}…',
    ...
    arkExitLink: 'Exit',
    arkExitPageTitle: 'Move Ark funds on-chain',
    arkExitPageIntro: 'Two ways to move your Ark balance back to regular on-chain Bitcoin.',
    arkCoopTitle: 'Cooperative (recommended)',
    arkCoopDesc: 'The Ark server co-signs one transaction paying your on-chain wallet. Fast — one confirmation — and needs no on-chain funds. A small server fee comes out of the amount.',
    arkUniTitle: 'Unilateral exit',
    arkUniDesc: 'Publishes your coins’ own exit transactions and claims them after a timelock (about a day), paying on-chain mining fees. Slower, but needs no cooperation from the server — your escape hatch if it ever disappears.',
    arkExitNoBalance: 'No Ark balance to move.',
    arkZapTitle: 'Zap over Ark',
    arkZapLookup: 'Looking up their Ark address…',
    arkZapNoArk: 'This nostr user hasn’t published an Ark address.',
    arkZapHint: 'Instant and free — delivered to their Ark wallet, with a zap receipt on nostr.',
    ...
    arkLnPayVia: 'Instant, from your Ark balance',
    arkLnFee: 'Ark fee',
    ...
    nwcDesc: 'Let another app pay from this wallet over nostr — it never sees your keys, only spends within the limits you set, and you can cut it off at any time. Payments go out over Ark.',
    nwcTabWarning: 'Only works while Hal is open in a tab — it is not an always-on service.',
    ...
    nwcPouch: 'Pouch (spendable while closed)',
    nwcPouchDesc: 'Coins in the pouch can be spent by the background responder without opening Hal. Keep it small — top it up as it drains.',
    nwcPouchFund: 'Add to pouch',
    nwcPouchEmpty: 'Empty pouch',
    nwcPouchFunded: 'Moved {sats} sats into the pouch',
    nwcPouchEmptied: 'Moved {sats} sats back to the wallet',
    nwcPouchAmount: 'Amount (sats)',
    ...
    arkBridgeTitle: 'Lightning swap bridge',
    arkBridgeDesc: 'Optional third-party service that pays Lightning invoices from your Ark balance, usually cheaper than the Ark server itself. Trustless: your sats are locked in a hash contract the bridge can only take by actually paying your invoice.',
    arkBridgeUrl: 'Bridge URL',
    arkBridgeToken: 'Access token',
    arkBridgeTokenPh: 'Leave blank if the bridge is open',
    arkBridgeTrust: 'If the bridge fails to pay, your sats come straight back — it can never take them without settling your invoice.',
    arkLnBridgeFee: 'Bridge fee',
    ...
    arkExited: 'Exited on-chain',
    arkExitHistory: 'Ark exit',
