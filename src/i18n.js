...
const STR = {
  en: {
    ...
    hiwLn1: 'Your money sits in two places. Savings is ordinary on-chain Bitcoin: the safest place to keep it, but every move costs a mining fee and waits for a confirmation. Spending is for everyday use — it sends and arrives instantly, costs nothing to send, and still belongs only to you.',
