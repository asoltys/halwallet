...
const STR = {
  en: {
    ...
    arkExitChainStatus: 'Exit {n}: broadcasting the exit chain…',
    arkExitTimelockStatus: 'Exit {n}: waiting for the timelock (claimable at block {blocks})',
    arkExitClaimingStatus: 'Exit {n}: claim broadcast, awaiting confirmation',
