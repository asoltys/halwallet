...
const STR = {
  en: {
    ...
    hiwLnTitle: 'Spending and Saving',
    hiwLn1: 'Your money sits in two places. Saving is ordinary on-chain Bitcoin: the safest place to keep it, but every move costs a mining fee and waits for a confirmation. Spending is for everyday use — it sends and arrives instantly, costs nothing to send, and still belongs only to you.',
    hiwArkTitle: 'Moving between them',
    hiwArk1: 'Use “Move money” under your balance to shift funds either way. Money moved into Spending is ready after one confirmation; money moved back to Saving arrives the same way. You can always get your money out on your own, even if our server disappears — that path takes about a day and costs a mining fee. Behind the scenes this uses Ark and Lightning, but you never have to think about either.',
    ...
    receiveAddressTab: 'Saving address',
    receiveLnTab: 'Lightning',
    receiveSpTab: 'Silent payment',
    receiveArkTab: 'Instant',
    arkReceiveIntro: 'Receive instantly and free — straight into Spending.',
    arkTitle: 'Spending balance',
    arkDesc: 'Your Spending balance sends and receives instantly with no mining fees, and stays yours — you can move it back to Saving whenever you like.',
    ...
    arkBoardIntro: 'Move money from Saving into Spending:',
    arkBoardAvailable: '{n} in Saving',
    arkBoardNoFunds: 'Needs at least {n} sats in Saving.',
    arkRefreshBtn: 'Refresh / consolidate {n} coin(s)',
    arkOffboardBtn: 'Move {n} to Saving',
    ...
    arkOffboardedNote: 'Arrives in Saving after 1 confirmation.',
    arkOffboarded: 'Moved to Saving',
    arkOffboardHistory: 'Moved to Saving',
    arkExitBtn: 'Move to Saving without the server ({n} coin(s))',
    arkExitStarted: 'Unilateral exit started for {n} coin(s) — broadcasting the exit chain.',
    arkExitNoFeeCoin: 'This needs a little in Saving to pay the mining fees.',
    ...
    arkExitLink: 'Move to Saving',
    arkExitPageTitle: 'Move money to Saving',
    arkExitPageIntro: 'Two ways to move your Spending balance into Saving.',
    arkCoopTitle: 'Cooperative (recommended)',
    arkCoopDesc: 'The normal way: one transaction into Saving, ready after a single confirmation, with a small fee taken from the amount.',
    ...
    arkExited: 'Moved to Saving',
    arkExitHistory: 'Moved to Saving',
