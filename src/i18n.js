...
const STR = {
  en: {
    ...
    hiwBasics1: 'When you make a wallet, the page generates twelve random words — the key to your money. Anyone who has them can spend your coins, and if you lose them the coins are gone for good: there’s no reset link and no one to call. Write them down on paper before you put money in.',
    hiwBasics2: 'There’s no server and no account. The whole app is one page that runs in your browser — nobody holds your coins, nothing on a server ever sees your keys, and you can even save the page and use it offline.',
    hiwBasics3: 'It follows the standard Bitcoin formats, so the same twelve words will always restore your wallet in Sparrow, Electrum, or any other standard wallet — even if this site disappears.',
    ...
    hiwLn3: 'Shift money either way with “Move money” under your balance — keep what you’re saving in Savings, what you’ll use in Spending. Moving costs a small fee each way; paying inside Spending is free. The wallet handles the upkeep automatically (just open the app now and then), and every coin in Spending carries a pre-signed escape route: even if the coinos server vanished, you could pull your money back on-chain yourself, no permission needed.',
    hiwGiftsTitle: 'Gifts',
