...
const STR = {
  en: {
    ...
    hiwLn1: 'Your money sits in two places, a bit like a savings account and the cash in your pocket. Savings is ordinary Bitcoin on the blockchain — the safest place for money you’re keeping, but every move costs a mining fee and waits for a confirmation. Spending is for everyday use: payments send and arrive instantly, sending is free, and it’s still only your money — nobody else can spend it.',
    hiwLn2: 'Under the hood, Spending runs on Ark, a newer layer built on top of Bitcoin. Your Spending balance sits in a shared pool coordinated by a coinos server, but every coin in it is locked to your key — the server can’t move a sat without your signature. Spending also speaks Lightning, the payment network most bitcoin apps and shops use, so you can pay any Lightning invoice and anyone on Lightning can pay you.',
    hiwLn3: 'A good rule of thumb: money you plan to keep lives in Savings, money you plan to use lives in Spending — the same way you wouldn’t carry your life savings around in your pocket.',
    hiwArkTitle: 'Moving between them',
    hiwArk1: 'Use “Move money” under your balance to shift funds either way. Money moved into Spending is ready after one confirmation; money moved back to Savings arrives the same way. You can always get your money out on your own, even if our server disappears — that path takes about a day and costs a mining fee. Behind the scenes this uses Ark and Lightning, but you never have to think about either.',
    ...
    hiwArk3: 'The housekeeping is automatic: coins in Spending come with an expiry date some weeks out, and the wallet quietly renews them well ahead of it — just open the app now and then. Moving into Spending pays a small server fee plus a normal mining fee; paying inside Spending is free; moving back to Savings pays a server fee taken from the amount.',
    ...
    msgNoIdentity: 'No nostr identity available to sign with',
    ...
    receiveAddressTab: 'Savings address',
