...
const STR = {
  en: {
    ...
    hiwLn1: 'You can pay Lightning invoices and receive Lightning payments. They run over your Ark balance: the Ark server exchanges with the Lightning network without ever holding your money — if a payment fails, the coins come back to you. A small fee applies, shown before you confirm.',
    hiwArkTitle: 'Ark',
    ...
    namesDesc: 'Claim a human-readable payment address (₿you@halwallet.app) that anyone with a BIP-353 wallet can pay. It points at this wallet’s reusable Ark address and follows the wallet if that changes.',
    ...
    namesNeedArk: 'Ark must be connected to claim a name',
    namesNotFound: 'No payment record found for {name}',
    namesNoUsableInstruction: 'That name has a payment record, but nothing this wallet can pay',
    namesOwnDomain: 'Use your own domain',
    namesOwnDomainHow: 'Add this CNAME in your DNS (your zone must have DNSSEC enabled) and your name works at your own domain:',
